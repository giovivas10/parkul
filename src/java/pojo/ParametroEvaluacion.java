...
/**
 * ParametroEvaluacion generated by hbm2java
 */
public class ParametroEvaluacion  implements java.io.Serializable {
    ...
    public ParametroEvaluacion(String nombre) {
        this.nombre = nombre;
    }
    public ParametroEvaluacion(String nombre, Set daniosVehiculos) {
       this.nombre = nombre;
